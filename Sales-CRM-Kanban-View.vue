<template>
    ...
    <NuxtLayout name="sales">
      <SectionMain>
        <!-- heading menu  -->
        <section class="">
          <div class="shadow px-6 flex justify-between items-center py-2 " v-if="!editSection" @mouseover="editButton=true" @mouseleave="editButton=false">
          ...
          <!-- Edit -->
          <div class="shadow px-6 flex justify-between items-center py-2" v-if="editSection">
            <div class="flex justify-between items-center">
...
<script setup>
import { mdiMenuDown,mdiFullscreen ,mdiSquareEditOutline,mdiPrinterOutline ,mdiChartBar,mdiDeleteOutline,mdiTrackpad , mdiPlus, mdiLockOutline,mdiDotsHorizontal,mdiReload,mdiDotsVertical,mdiMenuUp ,mdiDialpad,mdiFileDocumentMultipleOutline,mdiDelete   } from "@mdi/js";
