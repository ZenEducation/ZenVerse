...
<template>
  ...
  >
    <div class="flex-1 p-3 flex-col flex-wrap justify-center">
      <div class="w-full flex-1 px-3 flex flex-wrap justify-center">
        <img class="h-8 mx-auto" src="@/assets/img/PeLogo.png" alt="" />
      </div>
      <div class="w-full flex-1 px-3 flex flex-wrap justify-center">
        <b v-if="isPrimaryMenuCompact" class="font-black">PE</b>
        <b v-else class="font-black">Paathshala Education</b>
      </div>
    </div>
