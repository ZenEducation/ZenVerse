<template>
    <div class="font-nunito text-base text-black dark:text-white dark:bg-slate-900">
                <!-- Start Hero -->
                <section class="relative table w-full py-72 bg-[url('../../assets/images/job/job.jpg')] bg-no-repeat bg-top bg-cover">
                                ...
                                <div class="lg:-mt-[330px] -mt-[299px]">
                                    <div class="rounded-md bg-white dark:bg-slate-900 shadow dark:shadow-gray-800">
                                        <div class="text-center py-8 p-6 border-b border-gray-100 dark:border-gray-700">
                                            <img src="assets/images/client/01.jpg" class="h-24 w-24 p-1 shadow-md dark:shadow-gray-800 mx-auto rounded-full block" alt="">
                                            <h5 class="mt-5 text-xl font-semibold mb-0">Thomas Brewer</h5>
                                            <p class="text-slate-400 mb-0">Senior Web Developer</p>
                                        </div>
        
                                        <div class="p-6">
                                            <h5 class="font-semibold">Company Details :</h5>
                                            <ul class="list-none mt-4">
                                                <li class="flex mt-2 items-center font-medium"><i data-feather="mail" class="h-4 w-4 text-amber-500 ltr:mr-3 rtl:ml-3"></i><span class="text-slate-400 ltr:mr-3 rtl:ml-3">Email  :</span> thomas@mail.com</li>
                                                <li class="flex mt-2 items-center font-medium"><i data-feather="gift" class="h-4 w-4 text-amber-500 ltr:mr-3 rtl:ml-3"></i><span class="text-slate-400 ltr:mr-3 rtl:ml-3">D.O.B. :</span> 31st Dec, 1996</li>
                                                <li class="flex mt-2 items-center font-medium"><i data-feather="home" class="h-4 w-4 text-amber-500 ltr:mr-3 rtl:ml-3"></i><span class="text-slate-400 ltr:mr-3 rtl:ml-3">Address :</span> 15 Razy street</li>
                                                <li class="flex mt-2 items-center font-medium"><i data-feather="map-pin" class="h-4 w-4 text-amber-500 ltr:mr-3 rtl:ml-3"></i><span class="text-slate-400 ltr:mr-3 rtl:ml-3">City :</span> London</li>
                                                <li class="flex mt-2 items-center font-medium"><i data-feather="globe" class="h-4 w-4 text-amber-500 ltr:mr-3 rtl:ml-3"></i><span class="text-slate-400 ltr:mr-3 rtl:ml-3">Country :</span> UK</li>
                                                <li class="flex mt-2 items-center font-medium"><i data-feather="server" class="h-4 w-4 text-amber-500 ltr:mr-3 rtl:ml-3"></i><span class="text-slate-400 ltr:mr-3 rtl:ml-3">Postal Code :</span> 521452</li>
                                                <li class="flex mt-2 items-center font-medium"><i data-feather="phone" class="h-4 w-4 text-amber-500 ltr:mr-3 rtl:ml-3"></i><span class="text-slate-400 ltr:mr-3 rtl:ml-3">Mobile :</span> (+125) 1542-8452</li>
                                            </ul>
                                            ...
                                            <a href="contact-one.html" class="btn bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-md mt-6">Contact Me</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="lg:col-span-8 md:col-span-7">
                                ...
                                <div class="flex mt-6">
                                    <div class="text-slate-400 font-semibold min-w-[80px] text-center">
                                        <img src="assets/images/client/shree-logo.png" class="h-16 w-16 mx-auto mb-2 block" alt=""> 2019-22
                                    </div>
                                ...
                                <div class="flex mt-6">
                                    <div class="text-slate-400 font-semibold min-w-[80px] text-center">
                                        <img src="assets/images/client/circle-logo.png" class="h-16 w-16 mx-auto mb-2 block" alt=""> 2017-19
                                    </div>
                                ...
                                <div class="grid lg:grid-cols-2 grid-cols-1 gap-6 mt-8">
                                    <div class="group relative block overflow-hidden rounded-md transition-all duration-500">
                                        ...
                                        <div class="content">
                                            <div class="icon absolute z-10 hidden group-hover:block top-4 ltr:right-4 rtl:left-4 transition-all duration-500">
                                            ...
                                            <div class="title absolute z-10 hidden group-hover:block bottom-4 ltr:left-4 rtl:right-4">
                                    ...
                                    <div class="group relative block overflow-hidden rounded-md transition-all duration-500">
                                        ...
                                        <div class="content">
                                            <div class="icon absolute z-10 hidden group-hover:block top-4 ltr:right-4 rtl:left-4 transition-all duration-500">
                                                <a href="assets/images/portfolio/2.jpg" class="btn bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white btn-icon rounded-full lightbox"><i class="uil uil-camera"></i></a>
                                            </div>
                
                                            <div class="absolute z-10 hidden group-hover:block bottom-4 ltr:left-4 rtl:right-4 transition-all duration-500">
                                                <a href="portfolio-detail-one.html" class="h6 text-md font-medium text-white hover:text-indigo-600 duration-500 ease-in-out">Mockup Collection</a>
                                                <p class="text-slate-100 tag mb-0">Abstract</p>
                                            </div>
                                        </div>
...
<script setup>
import CandidateSkillSingle from './CandidateSkillSingle.vue';
