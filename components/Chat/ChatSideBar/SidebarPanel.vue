<template>
  <!-- Sidebar Panel -->
  <div class="fixed xl:static top-0 left-0 z-40 h-full shrink-0 transform-gpu transition-transform duration-200 ease-in translate-x-0">
    <div
      class="flex h-screen max-w-sm grow flex-col ml-0 bg-white dark:bg-navy-750"
    >
      <!-- Sidebar Panel Header -->
      <div class="flex h-18 w-full items-center justify-between pl-4 pr-1 py-2">
        <!-- on open -->
        <div class="flex items-center">
          <div class="avatar mr-3 hidden h-9 w-9 lg:flex">
            <div
              class="w-full h-full rounded-full flex bg-primary/10 text-primary dark:bg-accent-light/10 dark:text-accent-light"
            >
              <svg
          ...
          <p
            class="text-lg font-medium text-slate-800 line-clamp-1 dark:text-navy-100"
          >
            Chat
          </p>
        </div>
