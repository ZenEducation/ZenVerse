...
<template>
    <div class="grid grid-cols-1 gap-6 mb-6 xl:grid-cols-4">
        ...
        >
              <PremFormField label="mock test Name *">
                <PremFormControl
                required
                type="text"
                />
              ...
              <PremFormField label="mock test ID *">
                <PremFormControl
                required
                type="text"
                />
              ...
              <p class="font-bold"> mock test Image</p>
              <p class="text-sm mb-7">Upload a relatable mock test image for visual presentation</p>
