...
const pricingOptions = ref([
  { id: 0, label: "Make this a free mock test", value: "free" },
  { id: 1, label: "make this a paid mock test", value: "paid" },
]);
...
/>
  ...
  <div class="grid grid-cols-1 gap-6 mb-6 xl:grid-cols-4">
    ...
    >
      ...
      <p class="text-xs mb-4">
        Set mock test price for your learners
      </p>
      ...
      <p class="text-xs mb-4">
        Set a variable pricing for your mock test based on different validity
      </p>
