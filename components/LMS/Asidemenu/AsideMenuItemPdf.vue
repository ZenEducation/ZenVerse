...
import PremAsideMenuList from "@/components/LMS/Asidemenu/AsideMenuListPdf.vue";
...
const isAsideCompact = computed(() => false);
...
const menuClick = (event) => {
  ...
  console.log("Aside Menu Item", event, props.item);
