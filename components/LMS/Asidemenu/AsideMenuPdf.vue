...
import PremAsideMenuLayer from "@/components/LMS/Asidemenu/AsideMenuLayerPdf.vue";
import PremAsideMenuItem from "@/components/LMS/Asidemenu/AsideMenuItemPdf.vue";
...
const expandCollapseItem = computed(() => ({
  label: isPrimaryMenuCompact.value ? "Expand" : "Collapse",
