<template>
  ...
  >
    <div class="w-5/12 bg-white dark:bg-slate-900 h-screen opacity-100 p-5">
      <div class="text-3xl">Create Task</div>
      <div
      ...
      >
        <div class="flex justify-between items-center mt-8">
          <div class="font-medium text-xl">Task Information</div>
        ...
        <div class="mt-5">
          <PremFormField label="Task Name">
            <PremFormControl type="text" v-model="taskName" />
          </PremFormField>

          <PremFormField label="Due Date" horizontal>
            <PremFormControl type="date" v-model="date" />
          </PremFormField>
