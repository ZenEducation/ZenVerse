...
<template>
  <CardBoxModal
    ...
    buttonLabel="Okay"
  >
    <p>You can edit Approver details here.(WIP)</p>
  </CardBoxModal>
  ...
  <CardBoxModal
    ...
    title="Are you sure you want to Change status of this Approver?"
    button="danger"
    buttonLabel="Yes"
    has-cancel
  ...
  <div class="text-gray-500 dark:text-white">
    <span>{{ filteredItems.length }} Approvers</span>
  </div>
  ...
  <table>
    ...
    <tbody>
      <tr v-for="Approvers in filteredItems" :key="Approvers.id">
        <td class="border-b-0 lg:w-6 before:hidden">
          <UserAvatar
            :username="Approvers.name"
        ...
        <td data-label="Last Login" class="lg:w-1 whitespace-nowrap">
          <small
            ...
            :title="Approvers.lastLogin"
            >{{ Approvers.lastLogin }}</small
          >
        </td>
        <td data-label="Joined" class="lg:w-1 whitespace-nowrap">
          <small
            class="text-gray-500 dark:text-slate-400"
            :title="Approvers.joinedOn"
            >{{ Approvers.joinedOn }}</small
          >
        </td>
        <TableLearnerEnabled
          data-label="Enabled"
          :checked="Approvers.isEnabled"
          @click="EnableItem(true, Approvers.id)"
        />
        <td class="before:hidden whitespace-nowrap flex gap-2">
          <NuxtLink to="/cms/usermgmt/ApproverMgmtEdit">
          ...
          <BaseButton
            ...
            :icon="mdiTrashCan"
            small
            @click="deleteItem(true, Approvers.id)"
          />
        </td>
      </tr>
    </tbody>
