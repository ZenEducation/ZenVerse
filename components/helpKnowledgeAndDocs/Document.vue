      ...
      <SelectDropdown>
        ...
        <template v-slot:options>
          <ul class="flex flex-col">
            ...
            <li @click="docForm.status = 'ARCHIVED'" class="selectDdBtn">
              <p>ARCHIVED</p>
            </li>
          </ul>
        </template>
          ...
          <div>
            ...
            >
              ...
              <PremFormField>
                ...
                <!-- PARENT CATEGORY -->
                <PremFormField label="Parent Category" v-model="category.level">
                  <SelectDropdown>
                    <template v-slot:title>
...
watch(
  () => docForm,
  (newValue) => {
    UpdateDocStorage(newValue);
  },
  { deep: true }
);

const UpdateDocStorage = (data) => {
  const updatedData = { ...data._value };
  const store = useGlobalStore();
  store.updateGlobalStore(updatedData);
