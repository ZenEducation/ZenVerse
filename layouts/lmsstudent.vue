...
import { mdiForwardburger, mdiBackburger, mdiMenu, mdiPencil } from "@mdi/js";
import { useRouter } from "vue-router";
import menuAside from "@/configs/menuAside.js";
import menuNavBar from "@/configs/menuNavBarLmsStudent.js";
import { useMainStore } from "@/stores/main.js";
import { useLayoutStore } from "@/stores/layout.js";
import { useStyleStore } from "@/stores/style.js";
import BaseIcon from "@/components/Display/BaseIcon.vue";
import FormControl from "@/components/Forms/FormControl.vue";
import NavBar from "@/components/NavBar/NavBarLmsStudent.vue";
...
const layoutAsidePadding = computed(() =>
  layoutStore.isAsideLgActive ? "lg:0" : "xl:0"
);
      ...
      >
        ...
        >
          <div class=" flex items-center">
            <img class=" h-14" src="@/assets/img/PhotonLogo.png" alt="">
          </div>
