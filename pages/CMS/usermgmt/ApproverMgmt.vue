...
import TableApproversSample from "@/components/Tables/TableApproversSample.vue";
...
<template>
  <CardBoxModal v-model="isModalActive" :showFooter="false" title="">
    ...
    >
      ...
      <div class="flex flex-col ml-5 mx-auto">
        <h1 class="font-bold">Add Approver</h1>
        <h3 class="text-xs">Enter details to create Approver manually</h3>
      </div>
    ...
    <CardBox is-form @submit.prevent="submitProfile">
      ...
      <FormField label="Current password">
        <FormControl
          ...
          placeholder="Set password for Approver"
        />
      </FormField>
      <FormCheckRadio
        name="notifyUser"
  ...
  <div>
    <NuxtLayout name="cmslayout">
      ...
      >
        <div class="heading">
          <h1 class="font-bold text-2xl">Approver Management</h1>
