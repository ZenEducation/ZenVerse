...
import TableCreatorsSample from "@/components/Tables/TableCreatorsSample.vue";
...
<template>
  <CardBoxModal v-model="isModalActive" :showFooter="false" title="">
    ...
    >
      ...
      <div class="flex flex-col ml-5 mx-auto">
        <h1 class="font-bold">Add Creator</h1>
        <h3 class="text-xs">Enter details to create Creator manually</h3>
      </div>
    ...
    <CardBox is-form @submit.prevent="submitProfile">
      ...
      <FormField label="Current password">
        <FormControl
          ...
          placeholder="Set password for Creator"
        />
      </FormField>
      <FormCheckRadio
        name="notifyUser"
  ...
  <div>
    <NuxtLayout name="cmslayout">
      ...
      >
        <div class="heading">
          <h1 class="font-bold text-2xl">Creator Management</h1>
