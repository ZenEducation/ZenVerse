...
import InformationTab from "@/components/cms/MgmtEdit/CreatorEditInformation.vue";
    ...
    >
      ...
      >
        <div class="pt-8">
          ...
          <div class="w-full flex justify-center h-full">
            <h4 class="font-semibold text-xl">Creator 1</h4>
          </div>
          <div class="w-full flex justify-center h-full">
            <h4 class="font-semibold text-sm">Creator@ps.com</h4>
          </div>
