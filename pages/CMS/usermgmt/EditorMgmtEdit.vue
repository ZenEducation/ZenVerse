...
import InformationTab from "@/components/cms/MgmtEdit/EditorEditInformation.vue";
    ...
    >
      ...
      >
        <div class="pt-8">
          ...
          <div class="w-full flex justify-center h-full">
            <h4 class="font-semibold text-xl">Editor 1</h4>
          </div>
          <div class="w-full flex justify-center h-full">
            <h4 class="font-semibold text-sm">Editor@ps.com</h4>
          </div>
