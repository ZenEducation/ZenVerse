...
import InformationTab from "@/components/LMS/MgmtEdit/AdminEditInformation.vue";
    ...
    >
      ...
      >
        <div class="pt-8">
          ...
          <div class="w-full flex justify-center h-full">
            <h4 class="font-semibold text-xl">Admin 1</h4>
          </div>
          <div class="w-full flex justify-center h-full">
            <h4 class="font-semibold text-sm">Admin@ps.com</h4>
          </div>
