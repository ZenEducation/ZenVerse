...
import { mdiDotsVertical , mdiTrashCan , mdiWindowClose,mdiPencil } from "@mdi/js";
...
/>
  ...
  <CardBoxModal v-model="isEditDataActive" :showFooter="false" title="">
    ...
    >
      ...
      <div class="text-gray-500 cursor-pointer" @click="isEditDataActive = false">
        <BaseIcon v-if="mdiWindowClose" :path="mdiWindowClose" :size="32" />
      </div>
    </header>
    <CardBox is-form @submit.prevent="submitProfile">
          ...
          >
            ...
            <div>
              <template v-for="i in dripOptions">
                ...
                >
                  <div
                    class="h-12 px-4 flex items-center justify-between w-full bg-slate-300 rounded-sm"
                  >
                    <p>Unlimited access</p>
                    <div class="flex items-center">
                      <BaseButton label="COPY LINK" small />
                      <BaseIcon
                ...
                >
                  ...
                  <div class="w-full bg-slate-200 p-8">
                    ...
                    <PremFormField horizontal>
                      ...
                      />
                      <p class="text-xs">
                        Student pay this amount in the first month of the subscription.
                      </p>
                      <div class="flex flex-row flex-nowrap mt-5">
                        <PremFormControl type="number" placeholder="50" />
              ...
              <div class="flex  gap-4 flex-wrap ">
                ...
                <PremFormField label="Payment per payment (Rs.)" class="sm:w-1/2">
                  <PremFormControl type="number" placeholder="50" />
                </PremFormField>
                ...
                <div class="w-full bg-slate-200 p-8">
                  <p class="text-xs mb-4">Specify the number of days, after purchase, that a student will be enrolled in the course.</p>

                  <PremFormField label="Enrollment duration(Days)" help="Minimum:60 days"  class="w-1/2">
                    <PremFormControl type="number" placeholder="365" />

                  </PremFormField>
                  <p class="text-xs mb-4">This text will be displayed on the Buy Button on the course card and the course landing page.</p>
                  <PremFormField label='"Buy Button" text label' help="Limit : 30 characters" class="w-1/2">
            ...
            <table>
              ...
              <tbody>
                <tr v-for="(item, index) in list" :key="index">
                  ...
                  <td data-label="Amount / Price per payment">Rs. {{ item.amount }}</td>
                  <td data-label="Enrollment duration / Paid every">{{ item.time }} months </td>
                  <td>
