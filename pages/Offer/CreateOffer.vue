            ...
            <SectionMain>
                ...
                <div class="hidden">
                    <div ref="pdfContent">
                        ...
                        <p class="c66 subtitle" id="h.4ln4q8facorn"><span class="c16"><br> {{ subtitleText }} </span></p>

                        <div id="page2el"></div>

                        <p class="c51"><span class="c48">Dear {{ titleText
                        }},&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span
                                class="c39 c59">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                &nbsp;
                                &nbsp;
                        ...
                        <p class="c66"><span class="c53">TERMS OF THE INTERNSHIP<br><br></span><span class="c30">Dear
                                {{ titleText }},</span><span class="c53 c65"><br></span></p>
                        <p class="c66"><span class="c25 c40">We appreciate your interest in providing your Services as a
                            </span><span class="c17"> {{ subtitleText }} </span><span class="c31">&nbsp;</span><span
                        ...
                        <p class="c2"><span class="c62 c35 c85">2B.4. Stipend is {{ salaryText }} Salary for {{
                            totalTaskHour + " " + value }} of your work.
                                Learning time
                                is
...
const formData = ref({
    ...
    taskHour: value.value,
    numberTaskHour: totalTaskHour.value,
    additional: editorContent.value
})
...
onMounted(() => {
    ...
    if (formData) {
        savedOfferLater.value = formData.id
        titleText.value = formData.titleText
        subtitleText.value = formData.sub_title
        emailText.value = formData.email
        salaryText.value = formData.salary
        value.value = formData.value
        totalTaskHour.value = formData.totalTaskHour
        editorContent.value = formData.editorContent
        isSended.value = formData.isSended
...
const saveReview = async () => {
    if (confirm("Do You Want to Save This Testimonials") == true) {
        ...
        const newModel = await DataStore.save(
            new OfferLater({
                "OfferLaterNo": dataLength.toString(),
                "Name": titleText.value,
                "Designation": subtitleText.value,
                "Salary": salaryText.value,
                "Email": emailText.value,
        ...
        const formData = {
            id: savedOfferLater.value,
            titleText: titleText.value,
            sub_title: subtitleText.value,
            email: emailText.value,
            salary: salaryText.value,
            value: value.value,
            totalTaskHour: totalTaskHour.value,
...
import '@/pages/Offer/CreateOffer.css'
