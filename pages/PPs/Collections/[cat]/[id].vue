...
const _category = route.params.cat;
const _id = Number(route.params.id);

const collectionStore = useCollectionStore()[_category];

const profileForm = reactive({
  name: collectionStore.userName,
  email: collectionStore.email,
});
...
const submitProfile = () => {
  ...
  collectionStore.setUser(profileForm);
};
