        ...
        <NuxtLayout name="zen">
            <SectionMain>
                ...
                <div v-for="(testimonial, index) in displayedTestimonials" :key="index">
                    <CardBox class=" h-fit mb-6 g:mb-0 lg:col-span-2 xl:col-span-3" v-if="testimonial.isPublished" if-from
                                ...
                                <div>
                                    ...
                                    <div>
                                        ...
                                        <div v-for="(url, index) in testimonial.youtubeURL" :key="index"
                                            ...
                                            <iframe :src="`https://www.youtube.com/embed/${url}`" frameborder="0"
                                                :key="index" class=" w-[640px] max-w-full h-[360px] "
...
onMounted(async () => {
    try {
        ...
        testimonialData.value = data.sort((a, b) => {
