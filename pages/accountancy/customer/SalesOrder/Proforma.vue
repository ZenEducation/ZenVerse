<template>
  <NuxtLayout name="accounts">
    <div class="p-4">
      <p to="/accountancy/customer/invoice" class="font-normal text-lg border-b-2 mb-2">Proforma</p>
      ...
      <div class="flex flex-wrap gap-4">
        ...
        <FormControl
          ...
          class="w-1/3 max-md:w-full p-2"
        />
        <FormField label="Proforma Date" class="w-1/3 max-md:w-full p-2">
          <FormControl
        ...
        <FormField label="Expiry Date" class="w-1/3 max-md:w-full p-2">
          <FormControl
      ...
      <div class="flex justify-end gap-6 items-center my-5">
        ...
        <BaseButton label="Generate Proforma" color="info" @click="submitProfile" />
      </div>
    </div>
  </NuxtLayout>
</template>
