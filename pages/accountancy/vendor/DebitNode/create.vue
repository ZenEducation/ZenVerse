<template>
  <NuxtLayout name="accounts">
    <div class="p-4">
      <p to="/accountancy/customer/invoice" class="font-normal text-lg border-b-2 mb-2">Debit Node</p>
      ...
      <div class="flex flex-wrap gap-4">
        ...
        <FormControl
          ...
          class="w-1/3 max-md:w-full p-2"
        />
        <FormField label="Debit Node Date" class="w-1/3 max-md:w-full p-2">
          <FormControl
            placeholder="Debit Node Date"
            type="date"
      ...
      <div class="flex justify-end gap-6 items-center my-5">
        ...
        <BaseButton label="Generate Debit Node" color="info" @click="submitProfile" />
      </div>
    </div>
  </NuxtLayout>
</template>
