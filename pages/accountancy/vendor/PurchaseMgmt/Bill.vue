<template>
  <NuxtLayout name="accounts">
    <div class="p-4">
      <p class="font-normal text-lg border-b-2 mb-2">Purchase</p>
      ...
      <div class="grid grid-cols-3 gap-2 max-md:grid-cols-2 max-sm:grid-cols-1">
        <div class="">
          <p>Billing Address</p>
          <div class="grid grid-cols-1 gap-2 p-4 my-2 border rounded">
      ...
      <FormField label="Select Order" class="w-2/3 max-md:w-full p-2" >
        <FormControl :options="['Order1','Order2']"/>
      </FormField>

      <div class="flex flex-wrap gap-4">
        <FormField label="Voucher Number" class="w-1/3 max-md:w-full p-2">
          <FormControl
            placeholder="Voucher Number"
            v-model="addFormData.voucherNo"
          />
        </FormField>
        <FormField label="Bill Date" class="w-1/4 max-md:w-full p-2">
        ...
        <FormField label="Due Date" class="w-1/4 max-md:w-full p-2">
      ...
      <div class="flex justify-end gap-6 items-center my-5">
        ...
        <BaseButton label="Save" color="info" @click="submitProfile" />
      </div>
    </div>
  </NuxtLayout>
</template>
