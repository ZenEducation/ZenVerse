...
const settingsTabs = ["Integration", "Pur. Order", "Pur Bill"];
...
<template>
  <NuxtLayout name="accounts">
    ...
    <div class="px-7" v-if="currentMainTab == 0">
      ...
      <div>
        <div class="text-gray-500 dark:text-white mt-4">
          <span>{{ filteredItems.length }} Orders</span>
        </div>
    ...
    <div class="px-7" v-if="currentMainTab == 1">
      <div
        class="flex gap-2 flex-wrap justify-between border-b border-gray-300 p-2 mt-1 xl:max-w-7xl xl:mx-auto"
      >
        <div class="flex flex-wrap gap-2">
          <NuxtLink to="/accountancy/vendor/purchaseMgmt/Bill">
            <BaseButton
              class="flex-1"
              type="submit"
              label="+ New Bill"
      ...
      <div>
        <div class="text-gray-500 dark:text-white mt-4">
          <span>{{ filteredItems.length }} Bills</span>
        </div>
    ...
    <div class="p-7" v-if="currentMainTab == 2">
      <div
