    ...
    <CardBoxModal v-model="isModalActive" :showFooter="false" title="">
      ...
      <CardBox is-form @submit.prevent="submitProfile">
        ...
        <div class="flex gap-3 items-center border-y-2 mt-5 ">
          <p class="text-lg font-bold cursor-pointer" @click="currentTab=0" :class="{'text-blue-400 underline': currentTab==0 }">Address</p>
          <p class="text-lg font-bold cursor-pointer" @click="currentTab=1" :class="{'text-blue-400 underline': currentTab==1 }" >Contact</p>
          <p class="text-lg font-bold cursor-pointer" @click="currentTab=2" :class="{'text-blue-400 underline': currentTab==2 }">Others</p>
          <p class="text-lg font-bold cursor-pointer" @click="currentTab=3" :class="{'text-blue-400 underline': currentTab==3 }">Custom</p>
        ...
        <div v-if="currentTab==1">
          <div class="flex gap-2 flex-wrap items-center">
            <FormField label="Attention to (will be used in Invoice)" class="w-full">
              <FormControl
              />
            </FormField>
