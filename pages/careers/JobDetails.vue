<template>
  <!-- Start Hero -->
  <section
    class="md:h-screen py-36 h-auto relative flex items-center background-effect overflow-hidden bg-[url('../../images/job/job.jpg')] bg-cover"
  >
    <div class="container-fluid">
      <div
        class="absolute inset-0 z-0 bg-[url('../../images/job/curve-shape.png')] dark:bg-[url('../images/job/curve-shape-dark.png')] bg-cover"
      ></div>
    </div>
    <!--end container-->
    ...
    <div class="container z-1">
      <div class="grid grid-cols-1 mt-10">
        ...
        >
          ...
          Choose Your <span class="text-indigo-600">New Job</span>
        </h4>
                  ...
                  >
                    ...
                    <div class="filter-search-form relative filter-border">
                      ...
                      <select
                        ...
                        aria-label="Default select example"
                      >
                        <option selected="true" value="1">Full Time</option>
        ...
        <div class="mt-6">
          <span class="text-slate-400"
            ><span class="text-dark">Popular Searches :</span> Designer
    ...
    <ul class="circles p-0 mb-0">
      <li class="brand-img">
        <img src="@/images/client/shree-logo.png" class="w-9 h-9" alt="" />
      </li>
      <li class="brand-img">
        <img src="@/images/client/skype.png" class="w-9 h-9" alt="" />
      </li>
      <li class="brand-img">
        <img src="@/images/client/snapchat.png" class="w-9 h-9" alt="" />
      </li>
      <li class="brand-img">
        <img src="@/images/client/spotify.png" class="w-9 h-9" alt="" />
      </li>
      <li class="brand-img">
        <img src="@/images/client/telegram.png" class="w-9 h-9" alt="" />
      </li>
      <li class="brand-img">
        <img src="@/images/client/whatsapp.png" class="w-9 h-9" alt="" />
      </li>
      <li class="brand-img">
        <img src="@/images/client/android.png" class="w-9 h-9" alt="" />
      </li>
      <li class="brand-img">
        <img
      ...
      <li class="brand-img">
        <img src="@/images/client/linkedin.png" class="w-9 h-9" alt="" />
      </li>
      <li class="brand-img">
        <img src="@/images/client/google-logo.png" class="w-9 h-9" alt="" />
      </li>
    </ul>
  </section>
  <!--end section-->
  <div class="relative">
    <div class="absolute block w-full h-auto bottom-[25px] z-1 left-0">
      <a href=""
        ><i
          class="mdi mdi-arrow-down absolute top-0 left-0 right-0 text-center inline-flex items-center justify-center rounded-full bg-white dark:bg-slate-900 h-12 w-12 mx-auto shadow-md dark:shadow-gray-800"
        ></i
      ></a>
    </div>
  ...
  <section class="relative md:py-24 py-16">
    <div class="container">
      <div class="grid md:grid-cols-12 grid-cols-1 pb-8 items-end">
        <div
          class="lg:col-span-8 md:col-span-6 ltr:md:text-left rtl:md:text-right text-center"
        >
          <h3
        ...
        <div
          class="lg:col-span-4 md:col-span-6 ltr:md:text-right rtl:md:text-left hidden md:block"
        >
          <a
            href=""
            class="btn btn-link text-slate-400 hover:text-indigo-600 after:bg-indigo-600 duration-500 ease-in-out"
            >All Categories <i class="uil uil-arrow-right align-middle"></i
          ></a>
        </div>
      </div>
      <!--end grid-->
      ...
      <div class="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
        ...
        <div class="lg:col-span-7 md:col-span-6">
          <div class="ltr:lg:ml-5 rtl:lg:mr-5">
            <h3
              class="mb-6 md:text-3xl text-2xl lg:leading-normal leading-normal font-medium"
            >
              We are Largest Job <br />
              Site in The World
            </h3>
            ...
            <p class="text-slate-400 max-w-xl">
              ...
              positions within the text. This might also explain why one can now
              find slightly different versions.
            </p>
    ...
    <div class="container mt-12">
      <div class="grid grid-cols-2 md:grid-cols-4">
        <div class="counter-box relative text-center">
          <h3 class="font-extrabold lg:text-[72px] text-[50px] opacity-5">
            <span class="counter-value" data-target="200">3</span>+K
          </h3>
          <span
            class="counter-head font-semibold text-xl absolute top-2/4 left-0 right-0"
            >Total User</span
          >
        </div>
        <!--end counter box-->
        ...
        <div class="counter-box relative text-center">
          <h3 class="font-extrabold lg:text-[72px] text-[50px] opacity-5">
            <span class="counter-value" data-target="15">1</span>+
          </h3>
          <span
            class="counter-head font-semibold text-xl absolute top-2/4 left-0 right-0"
        ...
        <div class="counter-box relative text-center">
          <h3 class="font-extrabold lg:text-[72px] text-[50px] opacity-5">
            <span class="counter-value" data-target="54">5</span>
          </h3>
          <span
            class="counter-head font-semibold text-xl absolute top-2/4 left-0 right-0"
            >Offices in the World</span
          >
        </div>
        <!--end counter box-->
        ...
        <div class="counter-box relative text-center">
          <h3 class="font-extrabold lg:text-[72px] text-[50px] opacity-5">
            <span class="counter-value" data-target="125">12</span>K
          </h3>
          <span
            class="counter-head font-semibold text-xl absolute top-2/4 left-0 right-0"
            >No. of Job Positions</span
          >
        </div>
        <!--end counter box-->
      </div>
        ...
        <div class="rounded-md shadow dark:shadow-gray-800">
          <div class="p-6">
            <a
              ...
              class="title h5 text-lg font-semibold hover:text-indigo-600"
              >Software Engineering</a
            >
            <p class="text-slate-400 mt-2">
              <i class="uil uil-clock text-indigo-600"></i> Posted 3 Days ago
            </p>
            ...
            <div class="flex justify-between items-center mt-4">
              ...
              <p class="text-slate-400">
                <i class="uil uil-usd-circle text-indigo-600"></i> $950 -
                $1100/mo
              </p>
            </div>
          </div>
        ...
        <div class="rounded-md shadow dark:shadow-gray-800">
          <div class="p-6">
            ...
            <div class="flex justify-between items-center mt-4">
              ...
              <p class="text-slate-400">
                <i class="uil uil-usd-circle text-indigo-600"></i> $2500 -
                $2600/mo
              </p>
            </div>
          </div>
        ...
        <div class="rounded-md shadow dark:shadow-gray-800">
          <div class="p-6">
            ...
            <div class="flex justify-between items-center mt-4">
              ...
              <p class="text-slate-400">
                <i class="uil uil-usd-circle text-indigo-600"></i> $3500 -
                $3600/mo
              </p>
            </div>
          </div>
        ...
        <div class="rounded-md shadow dark:shadow-gray-800">
          <div class="p-6">
            ...
            <div class="flex justify-between items-center mt-4">
              ...
              <p class="text-slate-400">
                <i class="uil uil-usd-circle text-indigo-600"></i> $2000 -
                $2500/mo
              </p>
            </div>
          </div>
        ...
        <div class="rounded-md shadow dark:shadow-gray-800">
          <div class="p-6">
            ...
            <div class="flex justify-between items-center mt-4">
              ...
              <p class="text-slate-400">
                <i class="uil uil-usd-circle text-indigo-600"></i> $1500 -
                $1600/mo
              </p>
            </div>
          </div>
        ...
        <div class="rounded-md shadow dark:shadow-gray-800">
          <div class="p-6">
            ...
            <div class="flex justify-between items-center mt-4">
              ...
              <p class="text-slate-400">
                <i class="uil uil-usd-circle text-indigo-600"></i> $500 -
                $600/mo
              </p>
            </div>
          </div>
        ...
        <div class="tiny-three-item">
          <div class="tiny-slide text-center">
            <div class="customer-testi">
              ...
              >
                <i
                  class="mdi mdi-format-quote-open mdi-48px text-indigo-600"
                ></i>
                <p class="text-slate-400">
    ...
    <div class="container md:mt-24 mt-16">
      <div class="grid md:grid-cols-12 grid-cols-1 items-center">
        ...
        <div class="lg:col-span-7 md:col-span-6">
          ...
          <div class="my-5">
            <a href=""
              ><img src="@/images/app/app.png" class="m-1 inline-block" alt=""
            /></a>
