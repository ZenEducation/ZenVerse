<template>
  ...
  <div class="absolute z-20 top-0 left-0 w-full min-h-[48px] bg-white">
  ...
  <div class="pt-28 h-screen w-full flex max-md:block max-md:overflow-y-scroll scrollbar-none">
    <!-- sidebar -->
