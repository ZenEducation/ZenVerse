...
<template>
  ...
  <div class="pt-20 h-screen overflow-y-scroll scrollbar-none px-8 pb-10">
    <div class="flex justify-between items-center p-8">
      <p class="text-2xl font-semibold">Score & Time Analysis</p>
    ...
    <div class="flex justify-between items-center p-8">
      <div class="flex gap-2">
        <span>Questions <b>5 </b> </span> <li>Correct <b>2</b></li>Incorrect <b>3</b> <li> Skipped <b>0</b></li><li> Score <b>2</b></li><li> Time Taken  <b>0.38 min</b></li>
      </div>
      <BaseButton label="Compare with Topper" />
    </div>
    <p class="font-bold">Correct Answer & Time Taken</p>
    <div class="w-2/3 mx-auto">

      <VerticalBarChart :labels='["Q1", "Q2" , "Q3" , "Q4"]' x_label="Questions" y_label="Time (Minutes)" :datasets='[
        {
                            data: [3.4 , 1.4 , 1.1 , 5 ],
                            backgroundColor: ["rgba(34, 136, 51, 0.75)" , "rgba(238, 102, 119, 0.75)" , "rgba(34, 136, 51, 0.75)" , "rgba(238, 102, 119, 0.75)"],
