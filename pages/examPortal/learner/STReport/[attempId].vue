...
const attemptId = route.params.attempId;
...
<template>
  ...
  <div v-if="loaded" class="pt-20 h-screen overflow-y-scroll scrollbar-none px-8 pb-10">
    ...
    <div class="w-2/3 mx-auto">
      ...
      <VerticalBarChart :labels='finalData.labelsList' x_label="Questions" y_label="Time (Minutes)" :datasets='[
        {
          data: finalData.timeList,
          backgroundColor: finalData.colorList,
          barPercentage: 0.4,
