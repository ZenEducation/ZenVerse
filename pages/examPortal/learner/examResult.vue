<template>
    ...
    <div class="w-4/5 pt-20 mx-auto  h-screen overflow-y-scroll scrollbar-none">
        <p class=" font-semibold text-4xl pb-4">JEE Main | FSTs | V01</p>
        <div class="flex gap-5 max-md:block">
            ...
            <div class="w-2/3  max-md:w-5/6 my-3 max-md:mx-auto border-2 rounded-lg py-10 px-4">
                <p class="">
                    total Marks: <span class="font-semibold">360</span>
                </p>
                ...
                <p class="">
                    You have scored  <span class="font-semibold">0 marks</span>
                    for correct answers, missed  <span class="font-semibold">0 marks</span>
                    on incorrect answers , lost  <span class="font-semibold">0 marks</span>
                    due to negative marking and  <span class="font-semibold">360 marks</span>
        ...
        <div class="flex justify-between items-center my-6 py-3">
            ...
            <NuxtLink to="/examportal/learner/SectionReport">
                <BaseButton label="Compare Section" :icon="mdiArrowRight" />
            </NuxtLink>

        </div>
        <div class="flex gap-5 max-md:block">
            <div class="w-1/4 max-md:w-5/6 my-3 max-md:mx-auto border-2 rounded-lg py-10 text-center" v-for="item in data.sections">
                <p  class=" font-semibold text-lg">
                    {{item.title}}
                </p>
                <p class="font-semibold text-2xl">
        ...
        <div class="flex justify-between items-center my-6 py-3">
            ...
            <NuxtLink to="/examPortal/learner/QuestionReport">
        ...
        <div class="flex justify-between items-center my-6 py-3">
            ...
            <NuxtLink to="/examportal/learner/STReport">
                <BaseButton label="View Report" :icon="mdiArrowRight" />
            </NuxtLink>
        ...
        <div class="flex justify-between items-center my-6 py-3">
            ...
            <NuxtLink to="/examportal/learner/TopicReport">
                <BaseButton label="View Report" :icon="mdiArrowRight" />
            </NuxtLink>
            
          </div>
          <div class="flex justify-center w-4/6">
            <VerticalBarChart :labels='["Others", "My Marks"]' x_label="Topic" y_label="Topic marks distribution And score" :datasets='[
              {
        ...
        <div class="flex justify-between items-center my-6 py-3">
            ...
            <NuxtLink to="/examportal/learner/DLReport">
                <BaseButton label="View Report" :icon="mdiArrowRight" />
            </NuxtLink>
...
const graph_data = {
    ...
    datasets: [{
      data: [data.total.correct, data.total.totalQue - data.total.correct ],
      backgroundColor: [
          'rgb(54, 162, 235)',
        'rgb(243, 236, 234)',
      ],
    ...
    datasets: [{
      data: [data.total.incorrect*(-1), (data.total.totalQue - data.total.incorrect)*(-1) ],
      backgroundColor: [
        'rgb(54, 162, 235)',
        'rgb(243, 236, 234)',
      ],
  ...
  negetiveMarking:{
    ...
    datasets: [{
      data: [data.total.incorrect, data.total.totalQue - data.total.incorrect ],
      backgroundColor: [
        'rgb(54, 162, 235)',
        'rgb(243, 236, 234)',
      ],
  ...
  skipped:{
    ...
    datasets: [{
      data: [data.total.Skipped, data.total.totalQue - data.total.Skipped ],
      backgroundColor: [
        'rgb(54, 162, 235)',
        'rgb(243, 236, 234)',
      ],
